...
public:
	...
	__forceinline vec3_t Weapon_ShootPosition( ) {
		if(g_hvh.test && this->index( ) == g_csgo.m_engine->GetLocalPlayer( ) ) {
...
public:
	...
	__forceinline bool IsAWP() { return m_iItemDefinitionIndex() >= Weapons_t::AWP; }

	__forceinline bool IsAuto() { return m_iItemDefinitionIndex() >= Weapons_t::SCAR20 && m_iItemDefinitionIndex() <= Weapons_t::G3SG1; }
