...
public:
	...
	struct Palette_t {
		...
		struct MenuColors_t {
			static Color Form() { return Color(18, 18, 18); }
			static Color Container() { return Color(18, 18, 18); }
			static Color Outlines( ) { return Color(61, 61, 61); }
	...
	{
		m_r = static_cast<unsigned char>(_r * 255.0f);
		m_g = static_cast<unsigned char>(_g * 255.0f);
		m_b = static_cast<unsigned char>(_b * 255.0f);
