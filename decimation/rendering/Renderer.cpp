...
IDirect3DTexture9* D3D::background;
IDirect3DTexture9* D3D::logotype;
...
ImFont* D3D::tabFont;
ImFont* D3D::menuFont;
ImFont* D3D::boldMenuFont;
ImFont* D3D::weaponFont;
ImFont* D3D::keybindsFont;
IDirect3DTexture9* D3D::menuBg;
ImFont* D3D::controlFont;
...
#include "../include/quarcstudio/rawdata.h"
#include "../include/quarcstudio/hashes.h"
#include "../include/quarcstudio/faprolight.hpp"
...
void D3D::Initialise( IDirect3DDevice9 *device ) {
	...
	D3D9DrawManager->update_screen_size(util::draw::position(( Width),( Height )));
	...
	D3D9Fonts[XYI_FONT] = D3D9DrawManager->add_font(XOR("C:\\Windows\\Fonts\\segoeui.ttf"), 14.f,
		false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING | util::draw::MONO_HINTING);
	...
	D3D9Fonts[ SUBTAP_FONT ] = D3D9DrawManager->add_font(XOR("C:\\Windows\\Fonts\\segoeuib.ttf"), 16.f,
		false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING | util::draw::MONO_HINTING);
	...
	Geforce = ImGui::GetIO().Fonts->AddFontFromMemoryCompressedTTF(MyGeforce_compressed_data, MyGeforce_compressed_size, 14);
	...
	Fallout = ImGui::GetIO().Fonts->AddFontFromMemoryCompressedTTF(MyFallout_compressed_data, MyFallout_compressed_size, 14);

	D3DXCreateTextureFromFileInMemoryEx(device, &background_raw, sizeof(background_raw), 800, 475, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &background);
	D3DXCreateTextureFromFileInMemoryEx(device, &logotype_raw, sizeof(logotype_raw), 256, 256, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &logotype);
}
